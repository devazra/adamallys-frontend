    ...
    return (
        <div>
            ...
            {products?.map((product) =>
                <div className="flex">
                    <p className="py-[21px] pl-4 md:pl-[50px] border-r border-theme-main text-theme-main border-b md:text-lg leading-[26px] basis-[40%]">{product?.attributes?.base_categories?.data?.attributes?.Name || 'N/A'}</p>
